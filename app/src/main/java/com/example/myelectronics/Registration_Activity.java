    ...
    void temp() {
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                //cables
                db.ProductDao().AddProduct(new OrmProduct("Anker 3 Feet USB-C to USB-C", "USB-C to USB-C cable with only power supply: This kind of cable is used to connect the adapter to device, or computer to device, such as lamps, toys, measuring tools, etc. which without data requirements", 5.99, "cables", R.drawable.cable1));
                ...
                db.ProductDao().AddProduct(new OrmProduct("Belkin USB-A to USB-C Charge Cable", "Charge Cable lets you charge your USB-C device as well as sync your photos, music and data to your existing laptop.", 6.99, "cables", R.drawable.cable3));
